...
(function () {
  ...
  angular.module('app.controllers').controller('appController', controller);
...
(function () {
  ...
  angular.module('app.controllers').controller('controlController', controller);
...
(function () {
  ...
  angular.module('app.controllers').controller('indexController', controller);
...
(function () {
  ...
  angular.module('app.directives').directive('ngBalloon', directive);
...
(function () {
  ...
  angular.module('app.directives').directive('ngDebug', directive);
...
(function () {
  ...
  angular.module('app.directives').directive('ngFileInput', directive);
  directive.$inject = ['$parse'];
...
(function () {
  ...
  angular.module('app.directives').directive('ngSidebar', directive);
...
(function () {
  ...
  angular.module('app.directives').directive('ngTop', directive);
...
(function () {
  ...
  angular.module('app.services').factory('$api', factory);
...
(function () {
  ...
  angular.module('app.services').factory('$config', factory);
...
(function () {
  ...
  angular.module('app.services').factory('$dict', factory);
  factory.$inject = [];
...
(function () {
  ...
  angular.module('app.services').factory('$notify', factory);
...
(function () {
  ...
  angular.module('app.services').factory('$ws', factory);
...
(function () {
  ...
  angular.module('app.controllers').controller('settingsHardwareSettingsController', controller);
...
(function () {
  ...
  angular.module('app.controllers').controller('settingsMqttSettingsController', controller);
...
(function () {
  ...
  angular.module('app.controllers').controller('settingsNtpTimeSettingsController', controller);
...
(function () {
  ...
  angular.module('app.controllers').controller('settingsUpdateController', controller);
...
(function () {
  ...
  angular.module('app.controllers').controller('settingsWirelessNetworkController', controller);
  controller.$inject = ['$rootScope', '$scope', '$ws'];
